...
export default class StateCityMapping extends LightningElement {
    ...
    constructor() {
        super()
        if (this.userObj.stateSelected === undefined) {
            this.userObj.stateSelected = 'Select an option'
            this.userObj.citySelected = 'Select an state first'
            this.mapping.stateSelected = this.userObj.stateSelected
            this.mapping.citySelected = this.userObj.citySelected
    ...
    @track mapping = {
        stateSelected: this.userObj.stateSelected,
        citySelected: this.userObj.citySelected,
        cities: []
    }
    ...
    @track stateList = Object.keys(this.data).map((stateName) => {
        return { label: stateName, value: stateName }
    })
